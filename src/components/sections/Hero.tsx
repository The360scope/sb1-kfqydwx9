            ...
            <span className="relative inline-block">
              <span
                ...
                style={{
                  ...
                  transform: `translateY(${currentWord === 0 ? '0' : '20px'})`,
                }}
              >
                Business
              </span>
              <span
                ...
                style={{
                  ...
                  transform: `translateY(${currentWord === 1 ? '0' : '20px'})`,
                }}
              >
                Marketing
              </span>
              <span
                ...
                style={{
                  ...
                  transform: `translateY(${currentWord === 2 ? '0' : '20px'})`,
                }}
              >
                Sales
              </span>
              <span
                ...
                style={{
                  ...
                  transform: `translateY(${currentWord === 3 ? '0' : '20px'})`,
                }}
              >
                Operations
              </span>
